...
class JointExecutor(MoveItExecutorBase):
    """Executor for joint-based motion commands"""
    ...
    def execute(self, msg, vel_scale=None, acc_scale=None):
        ...
        self.node.get_logger().info(
            f"[JointExecutor] Executing joint move with vel_scale={vel_scale:.2f}, acc_scale={acc_scale:.2f}"
        )
        ...
        return self._send_goal(req, "Joint move")
